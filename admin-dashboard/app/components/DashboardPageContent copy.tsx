                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {paginatedIncidents.map((incident) => (
                        <tr key={incident.id} className="hover:bg-gray-50">
                          <td className="whitespace-nowrap px-3 py-4 text-sm font-mono text-gray-500">{incident.id.slice(0, 8)}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{incident.title}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 capitalize">{incident.incident_type}</td>
